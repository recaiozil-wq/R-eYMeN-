...
try:
    ...
    logger.warning("[RunAgent] Modul yuklenemedi (L27): %s", ModuleNotFoundError)
    pass
...
from src.reymen.sistem.model_tools import (
...
from src.reymen.sistem.utils import atomic_json_write, base_url_host_matches, base_url_hostname
...
def _routermint_headers() -> dict:
    ...
    from ReYMeN_cli import __version__ as _ReYMeN_VERSION

    return {
        "User-Agent": f"ReYMeNAgent/{_ReYMeN_VERSION}",
    }
...
class AIAgent:
    ...
    _TOOL_CALL_ARGUMENTS_CORRUPTION_MARKER = (
        "[ReYMeN-agent: tool call arguments were corrupted in this session and "
    ...
    def _ensure_db_session(self) -> None:
        ...
        try:
            self._session_db.create_session(
                ...
                source=self.platform or os.environ.get("ReYMeN_SESSION_SOURCE", "cli"),
                model=self.model,
        ...
        **extra_context,
        ...
        if should_start and target_session_id and hasattr(engine, "on_session_start"):
            start_context = {
                ...
                "platform": getattr(self, "platform", None) or os.environ.get("ReYMeN_SESSION_SOURCE", "cli"),
    ...
    def _ensure_lmstudio_runtime_loaded(self, config_context_length: Optional[int] = None) -> None:
        """
        Preload the LM Studio model with at least ReYMeN' minimum context.
        """
    ...
    def _safe_print(self, *args, **kwargs):
        ...
        try:
            ...
            fn(*args, **kwargs)
        except (OSError, ValueError) as _run_agen_e693:
            print(f"[UYARI] run_agent.py:694 - {_run_agen_e693}")
    ...
    def _vprint(self, *args, force: bool = False, **kwargs):
        ...
        parseable single-query flows such as ``ReYMeN chat -q``. In that mode,
    ...
    def _emit_status(self, message: str) -> None:
        ...
        except Exception as _run_agen_e768:
            print(f"[UYARI] run_agent.py:769 - {_run_agen_e768}")
    ...
    def _emit_warning(self, message: str) -> None:
        ...
        try:
            self._vprint(f"{self.log_prefix}{message}", force=True)
        except Exception as _run_agen_e785:
            print(f"[UYARI] run_agent.py:786 - {_run_agen_e785}")
        if self.status_callback:
            try:
    ...
    def _buffer_status(self, message: str) -> None:
        ...
        try:
            ...
            logger.warning("[RunAgent] except Exception (L821): %s", Exception)
            pass
    ...
    def _buffer_vprint(self, message: str) -> None:
        ...
        except Exception as _run_agen_e832:
            print(f"[UYARI] run_agent.py:833 - {_run_agen_e832}")
    ...
    def _clear_status_buffer(self) -> None:
        ...
        try:
            ...
            if buf:
                buf.clear()
        except Exception as _run_agen_e841:
            print(f"[UYARI] run_agent.py:842 - {_run_agen_e841}")
    ...
    def _flush_status_buffer(self) -> None:
        ...
        try:
            ...
            for kind, msg in messages:
                ...
                except Exception as _run_agen_e865:
                    print(f"[UYARI] run_agent.py:866 - {_run_agen_e865}")
        except Exception as _run_agen_e867:
            print(f"[UYARI] run_agent.py:868 - {_run_agen_e867}")
    ...
    def _resolved_api_call_timeout(self) -> float:
        ...
        Priority:
          ...
          3. ``ReYMeN_API_TIMEOUT`` env var (legacy escape hatch)
          4. 1800.0s default
        ...
        helper, the hardcoded ``ReYMeN_API_TIMEOUT`` fallback would always be
        ...
        if cfg is not None:
            return cfg
        return float(os.getenv("ReYMeN_API_TIMEOUT", 1800.0))
    ...
    def _resolved_api_call_stale_timeout_base(self) -> tuple[float, bool]:
        ...
        Priority:
          ...
          3. ``ReYMeN_API_CALL_STALE_TIMEOUT`` env var
        ...
        env_timeout = os.getenv("ReYMeN_API_CALL_STALE_TIMEOUT")
    ...
    def _codex_silent_hang_hint(self, model: Optional[str] = None) -> Optional[str]:
        ...
        ReYMeN-agent #21444 for the symptom history.  The upstream backend
        ...
        return (
            ...
            "See ReYMeN-agent#21444 for symptom history."
        )
    ...
    def _provider_model_requires_responses_api(
        ...
        *,
        ...
        if normalized_provider == "copilot":
            try:
                from ReYMeN_cli.models import _should_use_copilot_responses_api
                return _should_use_copilot_responses_api(model)
            except Exception as _e:
                # Fall back to the generic GPT-5 rule if Copilot-specific
                # logic is unavailable for any reason.
                logger.warning("[RunAgent] except Exception (L1213): %s", Exception)
                pass
    ...
    def _decorate_xai_entitlement_error(detail: str) -> str:
        ...
        SuperGrok subscribers can use ReYMeN against xai-oauth.  Lots of
    ...
    def _redact_message_content(content):
        ...
        Respects ``ReYMeN_REDACT_SECRETS`` via ``redact_sensitive_text`` —
    ...
    def _save_session_log(self, messages: List[Dict[str, Any]] = None):
        ...
        whose external tooling consumes ``~/.ReYMeN/sessions/session_{sid}.json``
        ...
        try:
            ...
            for msg in messages:
                ...
                # output, or user paste. Respects ReYMeN_REDACT_SECRETS via
    ...
    def interrupt(self, message: str = None) -> None:
        ...
        if _tracker is not None and _tracker_lock is not None:
            ...
            for _wtid in _worker_tids:
                ...
                except Exception as _run_agen_e2039:
                    print(f"[UYARI] run_agent.py:2040 - {_run_agen_e2039}")
    ...
    def clear_interrupt(self) -> None:
        ...
        if _tracker is not None and _tracker_lock is not None:
            ...
            for _wtid in _worker_tids:
                ...
                except Exception as _run_agen_e2074:
                    print(f"[UYARI] run_agent.py:2075 - {_run_agen_e2074}")
    ...
    def _file_mutation_verifier_enabled(self) -> bool:
        ...
        ``ReYMeN_FILE_MUTATION_VERIFIER`` env var overrides config.  Exposed
        as a method so tests can patch a single seam without reaching into
        the private ``_turn_failed_file_mutations`` state dict.
        """
        try:
            import os as _os
            env = _os.environ.get("ReYMeN_FILE_MUTATION_VERIFIER")
            if env is not None:
                return env.strip().lower() not in {"0", "false", "no", "off"}
            # Read from the persisted config.yaml so gateway and CLI share
            # the same setting.  Import lazily to avoid a startup-time cycle.
            try:
                from ReYMeN_cli.config import load_config as _load_config
        ...
        except Exception as _run_agen_e2199:
            print(f"[UYARI] run_agent.py:2200 - {_run_agen_e2199}")
    ...
    def _format_file_mutation_failure_footer(cls, failed: Dict[str, Dict[str, Any]]) -> str:
        ...
        (e.g. ``~/.ReYMeN/config.yaml``) to a messaging channel (#35584).
        """
        if not failed:
            return ""
        lines = [
    ...
    def _turn_completion_explainer_enabled(self) -> bool:
        ...
        True).  ``ReYMeN_TURN_COMPLETION_EXPLAINER`` env var overrides
        config.  Exposed as a method so tests can patch a single seam,
        mirroring ``_file_mutation_verifier_enabled``.
        """
        try:
            import os as _os
            env = _os.environ.get("ReYMeN_TURN_COMPLETION_EXPLAINER")
            if env is not None:
                return env.strip().lower() not in {"0", "false", "no", "off"}
            # Read from the persisted config.yaml so gateway and CLI share
            # the same setting.  Import lazily to avoid a startup-time cycle.
        ...
        except Exception as _run_agen_e2296:
            print(f"[UYARI] run_agent.py:2297 - {_run_agen_e2296}")
    ...
    def _touch_activity(self, desc: str) -> None:
        ...
        process is a dispatcher-spawned worker (ReYMeN_KANBAN_TASK set),
        ...
        if os.environ.get("ReYMeN_KANBAN_TASK"):
            try:
                ...
                logger.warning("[RunAgent] except Exception (L2414): %s", Exception)
                pass
    ...
    def shutdown_memory_provider(self, messages: list = None) -> None:
        ...
        if self._memory_manager:
            ...
            except Exception as _run_agen_e2494:
                print(f"[UYARI] run_agent.py:2495 - {_run_agen_e2494}")
            try:
                self._memory_manager.shutdown_all()
            except Exception as _run_agen_e2498:
                print(f"[UYARI] run_agent.py:2499 - {_run_agen_e2498}")
        ...
        if hasattr(self, "context_compressor") and self.context_compressor:
            ...
            except Exception as _run_agen_e2507:
                print(f"[UYARI] run_agent.py:2508 - {_run_agen_e2507}")
    ...
    def commit_memory_session(self, messages: list = None) -> None:
        ...
        if self._memory_manager:
            try:
                self._memory_manager.on_session_end(messages or [])
            except Exception as _run_agen_e2518:
                print(f"[UYARI] run_agent.py:2519 - {_run_agen_e2518}")
        ...
        if hasattr(self, "context_compressor") and self.context_compressor:
            ...
            except Exception as _run_agen_e2532:
                print(f"[UYARI] run_agent.py:2533 - {_run_agen_e2532}")
    ...
    def _sync_external_memory_for_turn(
        ...
        *,
        ...
        except Exception as _run_agen_e2586:
            print(f"[UYARI] run_agent.py:2587 - {_run_agen_e2586}")
    ...
    def release_clients(self) -> None:
        ...
        try:
            ...
            for child in children:
                try:
                    ...
                    try:
                        child.close()
                    except Exception as _run_agen_e2622:
                        print(f"[UYARI] run_agent.py:2623 - {_run_agen_e2622}")
        except Exception as _run_agen_e2624:
            print(f"[UYARI] run_agent.py:2625 - {_run_agen_e2624}")
        ...
        try:
            ...
            if client is not None:
                ...
                self.client = None
        except Exception as _run_agen_e2633:
            print(f"[UYARI] run_agent.py:2634 - {_run_agen_e2633}")
    ...
    def close(self) -> None:
        ...
        try:
            cleanup_vm(task_id)
        except Exception as _run_agen_e2661:
            print(f"[UYARI] run_agent.py:2662 - {_run_agen_e2661}")

        # 3. Clean browser daemon sessions
        try:
            cleanup_browser(task_id)
        except Exception as _run_agen_e2667:
            print(f"[UYARI] run_agent.py:2668 - {_run_agen_e2667}")
        ...
        try:
            ...
            for child in children:
                try:
                    child.close()
                except Exception as _run_agen_e2678:
                    print(f"[UYARI] run_agent.py:2679 - {_run_agen_e2678}")
        except Exception as _run_agen_e2680:
            print(f"[UYARI] run_agent.py:2681 - {_run_agen_e2680}")
        ...
        try:
            ...
            if client is not None:
                ...
                self.client = None
        except Exception as _run_agen_e2689:
            print(f"[UYARI] run_agent.py:2690 - {_run_agen_e2689}")
    ...
    def _copilot_headers_for_request(self, *, is_vision: bool) -> dict:
        from ReYMeN_cli.copilot_auth import copilot_request_headers
    ...
    def _try_refresh_codex_client_credentials(self, *, force: bool = True) -> bool:
        ...
        # pool entry (``ReYMeN auth add xai-oauth``) whose tokens belong to
        ...
        try:
            if self.provider == "openai-codex":
                from ReYMeN_cli.auth import resolve_codex_runtime_credentials

                singleton_now = resolve_codex_runtime_credentials(
                    refresh_if_expiring=False,
                )
            else:
                from ReYMeN_cli.auth import resolve_xai_oauth_runtime_credentials
    ...
    def _try_refresh_nous_client_credentials(
        ...
        *,
        ...
        try:
            from ReYMeN_cli.auth import resolve_nous_runtime_credentials

            creds = resolve_nous_runtime_credentials(
                timeout_seconds=float(os.getenv("ReYMeN_NOUS_TIMEOUT_SECONDS", "15")),
                force_refresh=force,
            )
        except Exception as exc:
    ...
    def _try_refresh_copilot_client_credentials(self) -> bool:
        ...
        try:
            from ReYMeN_cli.copilot_auth import resolve_copilot_token
    ...
    def _try_refresh_anthropic_client_credentials(self) -> bool:
        ...
        except Exception as _run_agen_e3352:
            print(f"[UYARI] run_agent.py:3353 - {_run_agen_e3352}")
    ...
    def _apply_client_headers_for_base_url(self, base_url: str) -> None:
        ...
        if base_url_host_matches(base_url, "openrouter.ai"):
            ...
            from ReYMeN_cli.models import copilot_default_headers
            ...
            except Exception as _run_agen_e3407:
                print(f"[UYARI] run_agent.py:3408 - {_run_agen_e3407}")
            if _ph_headers:
    ...
    def _swap_credential(self, entry) -> None:
        ...
        if self.api_mode == "anthropic_messages":
            ...
            try:
                self._anthropic_client.close()
            except Exception as _run_agen_e3423:
                print(f"[UYARI] run_agent.py:3424 - {_run_agen_e3423}")
            ...
            if think_tail:
                ...
                if think_tail:
                    ...
                    for cb in callbacks:
                        try:
                            cb(think_tail)
                        except Exception as _run_agen_e3531:
                            print(f"[UYARI] run_agent.py:3532 - {_run_agen_e3531}")
        ...
        if scrubber is not None:
            ...
            if tail:
                ...
                for cb in callbacks:
                    try:
                        cb(tail)
                    except Exception as _run_agen_e3545:
                        print(f"[UYARI] run_agent.py:3546 - {_run_agen_e3545}")
    ...
    def _fire_stream_delta(self, text: str) -> None:
        ...
        for cb in callbacks:
            try:
                cb(text)
                delivered = True
            except Exception as _run_agen_e3637:
                print(f"[UYARI] run_agent.py:3638 - {_run_agen_e3637}")
        if delivered:
    ...
    def _fire_reasoning_delta(self, text: str) -> None:
        ...
        if cb is not None:
            try:
                cb(text)
            except Exception as _run_agen_e3648:
                print(f"[UYARI] run_agent.py:3649 - {_run_agen_e3648}")
    ...
    def _fire_tool_gen_started(self, tool_name: str) -> None:
        ...
        if cb is not None:
            try:
                cb(tool_name)
            except Exception as _run_agen_e3663:
                print(f"[UYARI] run_agent.py:3664 - {_run_agen_e3663}")
    ...
    def _materialize_data_url_for_vision(image_url: str) -> tuple[str, Optional[Path]]:
        ...
        try:
            ...
            try:
                os.unlink(tmp.name)
            except OSError as _run_agen_e3744:
                print(f"[UYARI] run_agent.py:3745 - {_run_agen_e3744}")
            raise
        path = Path(tmp.name)
    ...
    def _describe_image_for_anthropic_fallback(self, image_url: str, role: str) -> str:
        ...
        try:
            ...
            if cleanup_path and cleanup_path.exists():
                try:
                    cleanup_path.unlink()
                except OSError as _run_agen_e3786:
                    print(f"[UYARI] run_agent.py:3787 - {_run_agen_e3786}")
    ...
    def _supports_reasoning_extra_body(self) -> bool:
        ...
        if (
            ...
            try:
                from ReYMeN_cli.models import github_model_reasoning_efforts
    ...
    def _lmstudio_reasoning_options_cached(self) -> list[str]:
        ...
        if cached is not None:
            ...
            if opts or (_time.monotonic() - ts) < 60:
                return opts
        try:
            from ReYMeN_cli.models import lmstudio_model_reasoning_options
...
def main(
    ...
    # Handle tool listing
    if list_tools:
        from reymen.sistem.model_tools import get_all_tool_names, get_available_toolsets
        from reymen.sistem.toolsets import get_all_toolsets, get_toolset_info
