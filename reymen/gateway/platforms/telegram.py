...
from reymen.gateway.platforms.telegram_network import (
    TelegramFallbackTransport,
    discover_fallback_ips,
    parse_fallback_ip_env,
)
from reymen.cron.hermes_stubs import atomic_replace
...
class TelegramAdapter(BasePlatformAdapter):
    ...
    async def _handle_callback_query(
        ...
        if data.startswith("sc:"):
            ...
            if len(parts) == 3:
                ...
                try:
                    from reymen.cron.hermes_stubs import slash_confirm as _slash_confirm_mod
    ...
    async def _cache_observed_media(self, msg: Message, event: MessageEvent) -> None:
        ...
        """
        from reymen.gateway.platforms.base import cache_media_bytes
    ...
    def _text_batch_key(self, event: MessageEvent) -> str:
        ...
        """
        from reymen.gateway.session import build_session_key
    ...
    async def _handle_sticker(self, msg: Message, event: "MessageEvent") -> None:
        ...
        """
        from reymen.gateway.sticker_cache import (
    ...
    def _build_message_event(
        ...
        from reymen.gateway.platforms.base import resolve_channel_prompt
